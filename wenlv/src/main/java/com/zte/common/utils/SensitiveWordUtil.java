...
public class SensitiveWordUtil {	
    ...
    * @param str 敏感词库
    */
   private static void initSensitiveWordMap(String str) {
	   String[] arr=str.split("\\|");
		sensitiveWordMap = new HashMap<String, Object>();
		String val;
	    Map nowMap;
   ...
   public static void main(String[] args) {	  
       SensitiveWordUtil.init("怒|自己");
       String str = "自一己太多的伤感情怒哀乐而自己过于牵强的把自己的情感adb也附加c于银幕情节中，然后感动就流泪";
